...
func (r *TodoListPostgre) Delete(userId int, listId int) error {
...
func (r *TodoListPostgre) Update(userId, listId int, input todo.UpdateListInput) error {
	...
	fmt.Println(args)
	_, err := r.db.Exec(query, args) // args...
	return err
}
